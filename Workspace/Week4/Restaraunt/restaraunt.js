 ...
 stringify() {
    ...
    var plate1 = new Plate(
        'Vegan Falafel Taco',
        'Vegan taco with gluten-free almond-flour tortilla, lettuce, tomato and falafel.',
        6.95,
    ...
    console.log(plate1.name + ' is citrus-free: ' + plate1.isCitrusFree())